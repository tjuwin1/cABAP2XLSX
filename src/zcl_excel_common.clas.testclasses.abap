...
*             column_start     type zif_excel_data_decl=>zexcel_cell_column_alpha,
*             column_start_int type zif_excel_data_decl=>zexcel_cell_column,
*             column_end       type zif_excel_data_decl=>zexcel_cell_column_alpha,
*             column_end_int   type zif_excel_data_decl=>zexcel_cell_column,
...
*      ls_symsg_act type zif_excel_data_decl=>ty_syst,                    " actual   messageinformation of exception
*      ls_symsg_exp type zif_excel_data_decl=>ty_syst,                    " expected messageinformation of exception
...
** ============================
*    DATA ep_column type zif_excel_data_decl=>zexcel_cell_column_alpha.
*
** Test 1. Simple test
*    TRY.
...
** ==========================
** Test 1. Basic test
*    DATA ep_column type zif_excel_data_decl=>zexcel_cell_column.
*
*    TRY.
...
*
*    DATA: column     type zif_excel_data_decl=>zexcel_cell_column_alpha,
*          column_int type zif_excel_data_decl=>zexcel_cell_column,
...
*    DATA ep_value type zif_excel_data_decl=>zexcel_cell_value.
*
...
*
** Test 2. Basic conversion
*    DATA exp_value type zif_excel_data_decl=>zexcel_cell_value VALUE 0.
...
** ========================
*    DATA lv_encrypted_pwd type zif_excel_data_decl=>zexcel_aes_password.
*
*    TRY.
...
*    DATA: ls_test type zif_excel_data_decl=>zexcel_pane.
...
*    DATA complete_style  type zif_excel_data_decl=>zexcel_s_cstyle_complete.
*    DATA complete_stylex type zif_excel_data_decl=>zexcel_s_cstylex_complete.
*
*    CREATE OBJECT style.
*
...
*    DATA lv_excel_string     type zif_excel_data_decl=>zexcel_cell_value.
*
