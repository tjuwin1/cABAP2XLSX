...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    CLASS-METHODS set_initial_ext_date
      IMPORTING
        !ip_value TYPE csequence DEFAULT c_default .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    CLASS-DATA worksheet_name type zif_excel_data_decl=>zexcel_worksheets_name .
    CLASS-DATA worksheet_index type zif_excel_data_decl=>zexcel_active_worksheet .
    CLASS-DATA initial_ext_date TYPE c length 10 VALUE c_default.
...
*
*    DATA: ls_numfmt type zif_excel_data_decl=>zexcel_s_style_numfmt,
...
*    DATA: current_worksheet_title type zif_excel_data_decl=>zexcel_sheet_title.
*
