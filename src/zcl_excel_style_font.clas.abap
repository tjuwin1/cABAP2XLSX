...
*"* do not include other source files here!!!
    ...
    DATA bold TYPE abap_boolean .
    DATA color type zif_excel_data_decl=>zexcel_s_style_color .
    CONSTANTS c_family_decorative type zif_excel_data_decl=>zexcel_style_font_family VALUE 5. "#EC NOTEXT
    CONSTANTS c_family_modern type zif_excel_data_decl=>zexcel_style_font_family VALUE 3. "#EC NOTEXT
    CONSTANTS c_family_none type zif_excel_data_decl=>zexcel_style_font_family VALUE 0. "#EC NOTEXT
    CONSTANTS c_family_roman type zif_excel_data_decl=>zexcel_style_font_family VALUE 1. "#EC NOTEXT
    ...
    CONSTANTS c_scheme_major type zif_excel_data_decl=>zexcel_style_font_scheme VALUE 'major'. "#EC NOTEXT
    CONSTANTS c_scheme_none type zif_excel_data_decl=>zexcel_style_font_scheme VALUE ''. "#EC NOTEXT
    CONSTANTS c_scheme_minor type zif_excel_data_decl=>zexcel_style_font_scheme VALUE 'minor'. "#EC NOTEXT
    CONSTANTS c_underline_double type zif_excel_data_decl=>zexcel_style_font_underline VALUE 'double'. "#EC NOTEXT
    CONSTANTS c_underline_doubleaccounting type zif_excel_data_decl=>zexcel_style_font_underline VALUE 'doubleAccounting'. "#EC NOTEXT
    CONSTANTS c_underline_none type zif_excel_data_decl=>zexcel_style_font_underline VALUE 'none'. "#EC NOTEXT
    CONSTANTS c_underline_single type zif_excel_data_decl=>zexcel_style_font_underline VALUE 'single'. "#EC NOTEXT
    ...
    DATA underline TYPE abap_boolean .
    DATA underline_mode type zif_excel_data_decl=>zexcel_style_font_underline .

    METHODS constructor .
    METHODS get_structure
      RETURNING
        VALUE(es_font) type zif_excel_data_decl=>zexcel_s_style_font .
    METHODS calculate_text_width
      IMPORTING
        !i_text        type zif_excel_data_decl=>zexcel_cell_value
      RETURNING
