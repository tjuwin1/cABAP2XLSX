...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    CONSTANTS c_diagonal_both type zif_excel_data_decl=>zexcel_diagonal VALUE 3. "#EC NOTEXT
    CONSTANTS c_diagonal_down type zif_excel_data_decl=>zexcel_diagonal VALUE 2. "#EC NOTEXT
    CONSTANTS c_diagonal_none type zif_excel_data_decl=>zexcel_diagonal VALUE 0. "#EC NOTEXT
    CONSTANTS c_diagonal_up type zif_excel_data_decl=>zexcel_diagonal VALUE 1.   "#EC NOTEXT
    DATA diagonal TYPE REF TO zcl_excel_style_border .
    DATA diagonal_mode type zif_excel_data_decl=>zexcel_diagonal .
    ...
    METHODS get_structure
      RETURNING
        VALUE(es_fill) type zif_excel_data_decl=>zexcel_s_style_border .
