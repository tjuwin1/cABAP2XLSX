...
** Constant node name
    ...
    DATA:
      ...
      lt_cell_data      type zif_excel_data_decl=>zexcel_t_cell_data_unsorted,
      ls_shared_string  type zif_excel_data_decl=>zexcel_s_shared_string,
      lv_sytabix        TYPE i,
      lt_shared_strings TYPE TABLE OF zif_excel_data_decl=>zexcel_s_shared_string.

    FIELD-SYMBOLS:
      <sheet_content>     type zif_excel_data_decl=>zexcel_s_cell_data.
    ...
    DATA:
      BEGIN OF l_worksheet,
        ...
        BEGIN OF pagemargins,
          left   type zif_excel_data_decl=>zexcel_dec_8_2,
          right  type zif_excel_data_decl=>zexcel_dec_8_2,
          top    type zif_excel_data_decl=>zexcel_dec_8_2,
          bottom type zif_excel_data_decl=>zexcel_dec_8_2,
          header type zif_excel_data_decl=>zexcel_dec_8_2,
          footer type zif_excel_data_decl=>zexcel_dec_8_2,
        END OF pagemargins,
        BEGIN OF pagesetup,
...
*
    DATA:
      ...
      lts_sorted_columns          TYPE SORTED TABLE OF zif_excel_data_decl=>zexcel_cell_column
...
*
    DATA:
      lv_cell_style type zif_excel_data_decl=>zexcel_cell_style.

    FIELD-SYMBOLS:
      <cell>    TYPE ty_cell,
      <content> type zif_excel_data_decl=>zexcel_s_cell_data,
      <style>   type zif_excel_data_decl=>zexcel_s_styles_mapping.
