...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA name type zif_excel_data_decl=>zexcel_range_name .
    DATA guid type zif_excel_data_decl=>zexcel_range_guid .

    METHODS get_guid
      RETURNING
        VALUE(ep_guid) type zif_excel_data_decl=>zexcel_range_guid .
    METHODS set_value
      IMPORTING
    ...
    METHODS get_value
      RETURNING
        VALUE(ep_value) type zif_excel_data_decl=>zexcel_range_value .
    METHODS set_range_value
      IMPORTING
        !ip_value type zif_excel_data_decl=>zexcel_range_value .
...
*"* do not include other source files here!!!
  PRIVATE SECTION.
    ...
    DATA value type zif_excel_data_decl=>zexcel_range_value .
ENDCLASS.
