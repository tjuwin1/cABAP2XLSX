...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !ip_index     type zif_excel_data_decl=>zexcel_cell_column_alpha
    ...
    METHODS set_column_style_by_guid
      IMPORTING
        !ip_style_guid type zif_excel_data_decl=>zexcel_cell_style
      RAISING
        zcx_excel .
    METHODS get_column_style_guid
      RETURNING
        VALUE(ep_style_guid) type zif_excel_data_decl=>zexcel_cell_style
      RAISING
        zcx_excel .
