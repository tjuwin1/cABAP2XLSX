...
*"* do not include other source files here!!!
    ...
    METHODS create_serie
      IMPORTING
        ...
        !ip_lbl_from_col     type zif_excel_data_decl=>zexcel_cell_column_alpha OPTIONAL
        !ip_lbl_from_row     type zif_excel_data_decl=>zexcel_cell_row OPTIONAL
        !ip_lbl_to_col       type zif_excel_data_decl=>zexcel_cell_column_alpha OPTIONAL
        !ip_lbl_to_row       type zif_excel_data_decl=>zexcel_cell_row OPTIONAL
        !ip_lbl              TYPE string OPTIONAL
        !ip_ref_from_col     type zif_excel_data_decl=>zexcel_cell_column_alpha OPTIONAL
        !ip_ref_from_row     type zif_excel_data_decl=>zexcel_cell_row OPTIONAL
        !ip_ref_to_col       type zif_excel_data_decl=>zexcel_cell_column_alpha OPTIONAL
        !ip_ref_to_row       type zif_excel_data_decl=>zexcel_cell_row OPTIONAL
        !ip_ref              TYPE string OPTIONAL
        !ip_sername          TYPE string
        !ip_sheet            type zif_excel_data_decl=>zexcel_sheet_title OPTIONAL .
    METHODS set_style
      IMPORTING
