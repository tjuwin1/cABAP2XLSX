  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ts_filter,
        ...
        t_values         TYPE HASHED TABLE OF zif_excel_data_decl=>zexcel_cell_value WITH UNIQUE KEY table_line,
    ...
    DATA filter_area type zif_excel_data_decl=>zexcel_s_autofilter_area .
    ...
    METHODS get_filter_area
      RETURNING
        VALUE(rs_area) type zif_excel_data_decl=>zexcel_s_autofilter_area
      RAISING
        zcx_excel .
    METHODS get_filter_range
      RETURNING
        VALUE(r_range) type zif_excel_data_decl=>zexcel_cell_value
      RAISING
        zcx_excel.
    METHODS get_filter_reference
      RETURNING
        VALUE(r_ref) type zif_excel_data_decl=>zexcel_range_value
      RAISING
        zcx_excel .
    METHODS get_values
      RETURNING
        VALUE(rt_filter) type zif_excel_data_decl=>zexcel_t_autofilter_values .
    METHODS is_row_hidden
      IMPORTING
        !iv_row             type zif_excel_data_decl=>zexcel_cell_row
      RETURNING
        VALUE(rv_is_hidden) TYPE abap_bool .
    METHODS set_filter_area
      IMPORTING
        !is_area type zif_excel_data_decl=>zexcel_s_autofilter_area .
    METHODS set_text_filter
      IMPORTING
        !i_column            type zif_excel_data_decl=>zexcel_cell_column
    ...
    METHODS set_value
      IMPORTING
        !i_column type zif_excel_data_decl=>zexcel_cell_column
        !i_value  type zif_excel_data_decl=>zexcel_cell_value .
    METHODS set_values
      IMPORTING
        !it_values type zif_excel_data_decl=>zexcel_t_autofilter_values .
...
*"* do not include other source files here!!!
  PROTECTED SECTION.
    ...
    METHODS is_row_hidden_single_values
      IMPORTING
        !iv_row             type zif_excel_data_decl=>zexcel_cell_row
        !iv_col             type zif_excel_data_decl=>zexcel_cell_column
...
*  see method documentation how to use this
  ...
  METHOD validate_area.
    DATA: l_col                   type zif_excel_data_decl=>zexcel_cell_column,
          ls_original_filter_area type zif_excel_data_decl=>zexcel_s_autofilter_area,
          l_row                   type zif_excel_data_decl=>zexcel_cell_row.
