...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    CONSTANTS zcx_excel TYPE xstring VALUE '028C0ED2B5601ED78EB6F3368B1E4F9B' ##NO_TEXT.
    DATA error TYPE string .
    DATA syst_at_raise TYPE zif_excel_data_decl=>ty_syst.
    ...
    METHODS constructor
      IMPORTING
        ...
        !syst_at_raise TYPE zif_excel_data_decl=>ty_syst OPTIONAL .
