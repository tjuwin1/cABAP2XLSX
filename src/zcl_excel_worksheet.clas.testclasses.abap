...
CLASS ltc_calculate_table_bottom_rig DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA:
      ...
      field_catalog      TYPE zif_excel_data_decl=>zexcel_t_fieldcatalog,
      field_catalog_line TYPE zif_excel_data_decl=>zexcel_s_fieldcatalog,
      table_settings     TYPE zif_excel_data_decl=>zexcel_s_table_settings.  "class under test
...
CLASS ltc_check_cell_column_formula DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    METHODS: should_fail
      IMPORTING
        ip_formula_id type zif_excel_data_decl=>zexcel_s_cell_data-column_formula_id
        ip_formula    type zif_excel_data_decl=>zexcel_s_cell_data-cell_formula OPTIONAL
        ip_value      type zif_excel_data_decl=>zexcel_s_cell_data-cell_value OPTIONAL
        ip_row        type zif_excel_data_decl=>zexcel_s_cell_data-cell_row
        ip_column     type zif_excel_data_decl=>zexcel_s_cell_data-cell_column
        ip_exp        TYPE string
      RAISING
        zcx_excel.
...
CLASS ltc_check_overlapping DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                table_settings       type zif_excel_data_decl=>zexcel_s_table_settings,
    ...
    DATA: table_1_settings type zif_excel_data_decl=>zexcel_s_table_settings.
...
CLASS ltc_check_rtf DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    ...
    DATA t_rtf                  type zif_excel_data_decl=>zexcel_t_rtf.
    DATA underline_double_style TYPE REF TO zcl_excel_style.
    DATA s_rtf                  type zif_excel_data_decl=>zexcel_s_rtf.
    DATA act_rtf_1              type zif_excel_data_decl=>zexcel_s_rtf.
    DATA act_rtf_2              type zif_excel_data_decl=>zexcel_s_rtf.
    DATA act_rtf_3              type zif_excel_data_decl=>zexcel_s_rtf.
    DATA exp_rtf_1              type zif_excel_data_decl=>zexcel_s_rtf.
    DATA exp_rtf_2              type zif_excel_data_decl=>zexcel_s_rtf.
    DATA exp_rtf_3              type zif_excel_data_decl=>zexcel_s_rtf.
    ...
    METHODS:
      ...
      assert
        IMPORTING
          ...
          ip_colname_exp type zif_excel_data_decl=>zexcel_column_name OPTIONAL,

      assert_multi
        IMPORTING
          it_fc          type zif_excel_data_decl=>zexcel_t_fieldcatalog OPTIONAL
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters,
              BEGIN OF input,
                ...
                row          type zif_excel_data_decl=>zexcel_cell_row,
                row_to       type zif_excel_data_decl=>zexcel_cell_row,
              END OF input,
              BEGIN OF output,
                fails        TYPE abap_bool,
                column_start type zif_excel_data_decl=>zexcel_cell_column,
                column_end   type zif_excel_data_decl=>zexcel_cell_column,
                row_start    type zif_excel_data_decl=>zexcel_cell_row,
                row_end      type zif_excel_data_decl=>zexcel_cell_row,
              END OF output,
            END OF ty_parameters.
    DATA:
      cut TYPE REF TO zcl_excel_worksheet.  "class under test
...
CLASS ltc_normalize_style_param DEFINITION FOR TESTING
  ...
  PRIVATE SECTION.
    TYPES : BEGIN OF ty_parameters_output,
              fails TYPE abap_bool,
              guid  type zif_excel_data_decl=>zexcel_cell_style,
...
CLASS ltc_check_rtf IMPLEMENTATION.
  ...
  METHOD setup.
    DATA style_guid type zif_excel_data_decl=>zexcel_cell_style.
...
CLASS ltc_normalize_column_heading IMPLEMENTATION.
  ...
  METHOD default_text_if_none.
    ...
    CONSTANTS: lc_initial_line type zif_excel_data_decl=>zexcel_s_fieldcatalog VALUE IS INITIAL.
    DATA lt_fc type zif_excel_data_decl=>zexcel_t_fieldcatalog.
  ...
  METHOD assert.
    ...
    DATA:
      ls_fc type zif_excel_data_decl=>zexcel_s_fieldcatalog,
      lt_fc type zif_excel_data_decl=>zexcel_t_fieldcatalog.
    ...
    DATA lt_fc_result type zif_excel_data_decl=>zexcel_t_fieldcatalog.
...
CLASS ltc_normalize_style_param IMPLEMENTATION.
  ...
  METHOD assert.
    DATA: rtti       TYPE REF TO cl_abap_typedescr,
          message    TYPE string,
          act        type zif_excel_data_decl=>zexcel_cell_style,
          error      TYPE REF TO zcx_excel,
          input_text TYPE string.
