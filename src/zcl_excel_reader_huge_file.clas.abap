  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF t_cell_content,
        datatype type zif_excel_data_decl=>zexcel_cell_data_type,
        value    type zif_excel_data_decl=>zexcel_cell_value,
        formula  type zif_excel_data_decl=>zexcel_cell_formula,
        style    type zif_excel_data_decl=>zexcel_cell_style,
      END OF t_cell_content .
    TYPES:
      BEGIN OF t_cell_coord,
        row    type zif_excel_data_decl=>zexcel_cell_row,
        column type zif_excel_data_decl=>zexcel_cell_column_alpha,
      END OF t_cell_coord .
    TYPES:
      BEGIN OF t_cell.
    ...
    METHODS get_style
      IMPORTING
        !iv_index            TYPE any
      RETURNING
        VALUE(ev_style_guid) type zif_excel_data_decl=>zexcel_cell_style
      RAISING
        lcx_not_found .
