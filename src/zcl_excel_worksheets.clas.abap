...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA active_worksheet type zif_excel_data_decl=>zexcel_active_worksheet VALUE 1. "#EC NOTEXT .  .  .  .  .  .  .  .  . " .
    DATA name type zif_excel_data_decl=>zexcel_worksheets_name VALUE 'Worksheets'. "#EC NOTEXT .  .  .  .  .  .  .  .  . " .
    ...
    METHODS get
      IMPORTING
        !ip_index           type zif_excel_data_decl=>zexcel_active_worksheet
      RETURNING
    ...
    METHODS is_empty
      RETURNING
        VALUE(is_empty) TYPE abap_boolean .
    METHODS remove
      IMPORTING
        !ip_worksheet TYPE REF TO zcl_excel_worksheet .
    METHODS size
