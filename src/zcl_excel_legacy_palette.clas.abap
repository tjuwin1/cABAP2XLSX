...
*"* do not include other source files here!!!
    ...
    METHODS get_color
      IMPORTING
        !ip_index       TYPE i
      RETURNING
        VALUE(ep_color) type zif_excel_data_decl=>zexcel_style_color_argb
      RAISING
        zcx_excel .
    METHODS get_colors
      RETURNING
        VALUE(ep_colors) type zif_excel_data_decl=>zexcel_t_style_color_argb .
    METHODS set_color
      IMPORTING
        !ip_index TYPE i
        !ip_color type zif_excel_data_decl=>zexcel_style_color_argb
      RAISING
        zcx_excel .
  PROTECTED SECTION.
...
*"* do not include other source files here!!!
    ...
    DATA colors type zif_excel_data_decl=>zexcel_t_style_color_argb .
ENDCLASS.
