CLASS zcl_excel_drawing DEFINITION
  ...
  PUBLIC SECTION.
    CONSTANTS c_graph_pie type zif_excel_data_decl=>zexcel_graph_type VALUE 1.   "#EC NOTEXT
    CONSTANTS c_graph_line type zif_excel_data_decl=>zexcel_graph_type VALUE 2.  "#EC NOTEXT
    CONSTANTS c_graph_bars type zif_excel_data_decl=>zexcel_graph_type VALUE 0.  "#EC NOTEXT
    DATA graph_type type zif_excel_data_decl=>zexcel_graph_type .
    DATA title TYPE string VALUE 'image1.jpg'.              "#EC NOTEXT
    CONSTANTS type_image type zif_excel_data_decl=>zexcel_drawing_type VALUE 'image'. "#EC NOTEXT
    CONSTANTS type_chart type zif_excel_data_decl=>zexcel_drawing_type VALUE 'chart'. "#EC NOTEXT
    CONSTANTS anchor_absolute type zif_excel_data_decl=>zexcel_drawing_anchor VALUE 'ABS'. "#EC NOTEXT
    CONSTANTS anchor_one_cell type zif_excel_data_decl=>zexcel_drawing_anchor VALUE 'ONE'. "#EC NOTEXT
    CONSTANTS anchor_two_cell type zif_excel_data_decl=>zexcel_drawing_anchor VALUE 'TWO'. "#EC NOTEXT
    ...
    CONSTANTS type_image_header_footer type zif_excel_data_decl=>zexcel_drawing_type VALUE 'hd_ft'. "#EC NOTEXT
    ...
    METHODS get_from_col
      RETURNING
        VALUE(r_from_col) type zif_excel_data_decl=>zexcel_cell_column .
    METHODS get_from_row
      RETURNING
        VALUE(r_from_row) type zif_excel_data_decl=>zexcel_cell_row .
    METHODS get_guid
      RETURNING
        VALUE(ep_guid) type zif_excel_data_decl=>zexcel_guid .
    ...
    METHODS get_to_col
      RETURNING
        VALUE(r_to_col) type zif_excel_data_decl=>zexcel_cell_column .
    METHODS get_to_row
      RETURNING
        VALUE(r_to_row) type zif_excel_data_decl=>zexcel_cell_row .
    ...
    METHODS set_position
      IMPORTING
        ...
        !ip_from_col type zif_excel_data_decl=>zexcel_cell_column_alpha
    ...
    METHODS set_position2
      IMPORTING
        !ip_from   type zif_excel_data_decl=>zexcel_drawing_location
        !ip_to     type zif_excel_data_decl=>zexcel_drawing_location
        !ip_anchor type zif_excel_data_decl=>zexcel_drawing_anchor OPTIONAL .
    METHODS get_position
      RETURNING
        VALUE(rp_position) type zif_excel_data_decl=>zexcel_drawing_position .
    METHODS get_type
      RETURNING
        VALUE(rp_type) type zif_excel_data_decl=>zexcel_drawing_type .
    METHODS get_index
      RETURNING
...
* suppose 96 DPI
  ...
  METHOD set_position2.
    ...
    DATA: lv_anchor                     type zif_excel_data_decl=>zexcel_drawing_anchor.
    lv_anchor = ip_anchor.
