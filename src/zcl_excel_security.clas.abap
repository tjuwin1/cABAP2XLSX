...
*"* do not include other source files here!!!
  PUBLIC SECTION.
    ...
    DATA lockrevision TYPE abap_boolean .
    DATA lockstructure TYPE abap_boolean .
    DATA lockwindows TYPE abap_boolean .
    DATA revisionspassword type zif_excel_data_decl=>zexcel_revisionspassword .
    DATA workbookpassword type zif_excel_data_decl=>zexcel_workbookpassword .

    METHODS is_security_enabled
      RETURNING
        VALUE(ep_security_enabled) TYPE abap_boolean.
