CLASS zcl_excel_fill_template DEFINITION
  ...
  PUBLIC SECTION.
    ...
    TYPES: tv_range_name TYPE c LENGTH 30,
           BEGIN OF ts_range,
             sheet  type zif_excel_data_decl=>zexcel_sheet_title,
             name   TYPE tv_range_name,
             start  type zif_excel_data_decl=>zexcel_cell_row,
             stop   type zif_excel_data_decl=>zexcel_cell_row,
             id     TYPE i,
             parent TYPE i,
             length TYPE i,
           END OF ts_range,
           ...
           tt_sheet_titles TYPE STANDARD TABLE OF zif_excel_data_decl=>zexcel_sheet_title WITH DEFAULT KEY,
  ...
  PRIVATE SECTION.
    ...
    TYPES: tt_cell_data_no_key TYPE STANDARD TABLE OF zif_excel_data_decl=>zexcel_s_cell_data WITH DEFAULT KEY.

    METHODS fill_range
      IMPORTING
        !iv_sheet              type zif_excel_data_decl=>zexcel_sheet_title
        !iv_parent             type zif_excel_data_decl=>zexcel_cell_row
        !iv_data               TYPE data
        VALUE(iv_range_length) type zif_excel_data_decl=>zexcel_cell_row
        !io_sheet              TYPE REF TO zcl_excel_worksheet
      CHANGING
        !ct_cells              TYPE tt_cell_data_no_key
        !cv_diff               type zif_excel_data_decl=>zexcel_cell_row
...
CLASS zcl_excel_fill_template IMPLEMENTATION.
  ...
  METHOD fill_range.
    ...
    DATA: lt_tmp_cells_template        TYPE tt_cell_data_no_key,
          ...
          ls_cell                      type zif_excel_data_decl=>zexcel_s_cell_data,
...
*      replace variables of current range with data
  ...
  METHOD fill_sheet.
    ...
    FIELD-SYMBOLS:
      <any_data>       TYPE any,
      <ls_sheet_cell>  type zif_excel_data_decl=>zexcel_s_cell_data,
  ...
  METHOD find_var.
    ...
    DATA: lv_row            TYPE i,
          ...
          lv_highest_column type zif_excel_data_decl=>zexcel_cell_column,
